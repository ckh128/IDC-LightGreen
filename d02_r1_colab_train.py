"""Run after manually uploading d02_r1_manual.zip to Colab's /content sidebar."""
...
#                       project='/content/runs/detect', name='d02_r1', exist_ok=True)
