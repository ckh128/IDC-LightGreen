...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--export", type=Path, default=PROJECT / "d02_pseudolabel_yolo")
    parser.add_argument("--previews", type=Path, default=PROJECT / "processed_images" / "d02_pseudolabel_previews")
